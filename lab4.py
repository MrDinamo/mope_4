...
if Gp > Gt:
    ...
    d = 8
    if (t0 < ttabl):
        print("Коефіцієнт b0 не значимий")
        b0 = 0
        d = d - 1
    if (t1 < ttabl):
        print("Коефіцієнт b1 не значимий")
        b1 = 0
        d = d - 1
    if (t2 < ttabl):
        print("Коефіцієнт b2 не значимий")
        b2 = 0
        d = d - 1
    if (t3 < ttabl):
        print("Коефіцієнт b3 не значимий")
        b3 = 0
        d = d - 1
    if (t4 < ttabl):
        print("Коефіцієнт b4 не значимий")
        b4 = 0
        d = d - 1
    if (t5 < ttabl):
        print("Коефіцієнт b5 не значимий")
        b5 = 0
        d = d - 1
    if (t6 < ttabl):
        print("Коефіцієнт b6 не значимий")
        b6 = 0
        d = d - 1
    if (t7 < ttabl):
        print("Коефіцієнт b7 не значимий\n")
        b7 = 0
        d = d - 1
